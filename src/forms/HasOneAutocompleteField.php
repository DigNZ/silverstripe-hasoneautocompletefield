...
class HasOneAutocompleteField extends FormField
{
    ...
    {
        Requirements::javascript('dignz/hasoneautocompletefield: client/dist/js/hasoneautocompletefield.js');
        Requirements::css('dignz/hasoneautocompletefield: client/dist/css/hasoneautocompletefield.css');
